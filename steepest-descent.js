...
// Format 1/2xAx-bx+c
const solveQudraticBySteepestDescent = (A,B,c, x0) => {
...
const solveQudraticBySteepestDescentWithSteps = (A,B,c, x0) => {
...
export default solveQudraticBySteepestDescent;
export {solveQudraticBySteepestDescentWithSteps};
